...
const Home = () => {
    ...
    return ( 
        ...
        <Box display="flex" justifyContent="space-around" alignItems='center' flexWrap='wrap' >
            <Box borderRadius="0%" {...homeProps} >
                ...
                <Typography gutterBottom variant="h5" component="h2">
                 ...
                 <Button component={Link} exact to="/request" variant="contained" size="large" color="primary" endIcon={<ArrowRightAltIcon />} >Request Help</Button>
                ...
                achievementData.results.map((achievement, index) => {
                    return (
                        <Box display="flex" {...circleprops2} key={achievement.id}>
                            <Box borderRadius="50%" {...circleProps}>{achievement.number}+</Box>
                            <Typography gutterBottom variant="h5" component="h2">
                                {achievement.title}
                            </Typography>
                        </Box>
        ...
        <Box display="flex" justifyContent="center" alignItems='center' flexWrap='wrap' padding='1rem' bgcolor='#0D6199' color='white' >
            <Typography gutterBottom variant="h5" component="h2" color='white' align='center'>
                Join initiative of Robotics Association of Nepal[RAN] & Biotechnology Society of Nepal [BSN] in partnership with Nepal Health Research Council[NHRC] supported by The Asia Foundation [TAF].
            </Typography>
        </Box>
        <Box display="flex" justifyContent="center" flexWrap='wrap'>
            <Box display="flex" {...circleprops2}>
                ...
                <img src={'/BSNlogo.jpg'} alt="BSN logo" className={classes.logo} />  
                <img src={'/ranlogo.png'} alt="RAN logo" className={classes.logo} />      
            ...
            <Box display="flex" {...circleprops2}>
                ...
                <img src={'/NHRClogo.png'} alt="NHRC logo" className={classes.logo} />      
            ...
            <Box display="flex" {...circleprops2}>
                ...
                <img src={'/TAFlogo.jpg'} alt="TAF logo" className={classes.logo} />      
