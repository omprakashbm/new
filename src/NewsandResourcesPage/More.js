      ...
      <div className={classes.maincontainer}>
        <div className={classes.main}>
          ...
          <Typography
            ...
            style={{ padding: "10px" }}
          >
            Thank you for being curous and supportive toward MOT project. We
            will continually update our activities. Please follow us in social
            medias and consider to join Us.
          </Typography>
          <Typography
            variant="body1"
            color="textSecondary"
        ...
        <div className={classes.icons}>
          <a href="https://www.facebook.com/missionoxygenteam" target="blank">
            <img
              src="/facebook.png"
              alt="facebook"
              style={{
          ...
          <a href="https://www.instagram.com/missionoxygenteam/" target="blank">
            <img
              src={"/instagram.png"}
              alt="insta"
