      ...
      <div className={classes.cards}>
        <Grid className={classes.container}>
          ...
          <Typography variant="p" color="textSecondary">
            ...
            order at all times. Whether you purchase a new or used concentrator,
            the unit should be cleaned and maintained to prevent costly repairs.
            However, over time, your concentrator will likely require a
            professional evaluation and repair work. It is essential to know how
            to manage your system correctly so that you can keep using it for
            years to come.
          </Typography>
