...
const Navbar = () => {
    ...
    const list = (anchor) => (
        ...
        >
            <List >
                ...
                <ListItem button component={Link} to="/hospital" className={classes.mobileNav}>
                    <Typography  color="primary" >Hospitals</Typography>
                </ListItem>
    ...
    <AppBar color='transparent' position="static">
        {matches ? 
            <Toolbar>
                    <Box borderRadius="5%" {...defaultProps} flexGrow={1} component={NavLink} exact to="/" >
                    ...
                    <Button component={NavLink} exact to="/hospital" color="primary" className={classes.button}>Hospitals</Button>
