                ...
                <Box borderRadius="0%" {...testProps} >
                    ...
                    {/* <Box borderRadius="5%" {...circleProps}>
                        ...
                        <Typography variant="body2" color="textSecondary" component="p" color="inherit">
                            Help donate through Khalti.
                        </Typography>
                        <Button variant="default" size="large" color='inherit'  endIcon={<ArrowRightAltIcon />} >Learn More</Button>
                    </Box>    */}
                    <Box borderRadius="5%" {...circleProps}>
                        <img src={'/esewa.jpeg'} alt="ecg" className={classes.logo} />   
                        <Typography variant="body2" component="p">
                            Merchant Name : <br></br>Robotics Association of Nepal
                        </Typography>
                        <Typography variant="body2" component="p">
                            Merchant Code : <br></br>2001260021:81748
                        </Typography>
                        <Typography variant="body2" color="textSecondary" component="p" color="inherit">
                            Help donate through esewa.
                        </Typography>
                        {/* <Button variant="default" size="large" color='inherit'  endIcon={<ArrowRightAltIcon />} >Learn More</Button> */}
                    </Box>  
